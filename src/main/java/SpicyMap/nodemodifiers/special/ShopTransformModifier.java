...
public class ShopTransformModifier extends AbstractNodeModifier {
    ...
    public static final String ID = SpicyMapMod.makeID("ShopTransform");

    public int savedPurgeCost = 50;
    public static final int TRANSFORM_COST = 75;
    private static final Texture replacementImg = ImageMaster.loadImage("SpicyMapResources/images/ui/purge/Transform.png");
